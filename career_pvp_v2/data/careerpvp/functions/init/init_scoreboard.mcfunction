...
scoreboard objectives remove eff_r6
scoreboard objectives add eff_r6 dummy
scoreboard objectives remove eff_r8
scoreboard objectives add eff_r8 dummy
scoreboard objectives remove eff_r10
scoreboard objectives add eff_r10 dummy
scoreboard objectives remove eff_r12
scoreboard objectives add eff_r12 dummy
scoreboard objectives remove eff_r14
scoreboard objectives add eff_r14 dummy
scoreboard objectives remove eff_r16
scoreboard objectives add eff_r16 dummy