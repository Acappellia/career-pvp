...
execute as @p[distance=..20,tag=choose_8 ] at @s unless score @s career matches 8 run execute as @e[tag=team] if score @s team = @p team if entity @s[tag=chosen_8] run tellraw @p "不可以选择与队友重复的职业"
execute as @p[distance=..20,tag=choose_8 ] at @s unless score @s career matches 8 run execute as @e[tag=team] if score @s team = @p team if entity @s[tag=chosen_8] run tag @p remove choose_8
execute as @p[distance=..20,tag=choose_8 ] at @s unless score @s career matches 2 unless score @s career matches 5 unless score @s career matches 8..9 run execute as @e[tag=team] if score @s team = @p team if score @s career_support matches 2.. run tellraw @p "该类别职业已经达到上限。如需和队友更换，请先取消职业选择"
execute as @p[distance=..20,tag=choose_8 ] at @s unless score @s career matches 2 unless score @s career matches 5 unless score @s career matches 8..9 run execute as @e[tag=team] if score @s team = @p team if score @s career_support matches 2.. run tag @p remove choose_8
...
execute as @p[distance=..20,tag=choose_8,scores={career=11} ] at @s run execute as @e[tag=team] if score @s team = @p team run tag @s remove chosen_11
execute as @p[distance=..20,tag=choose_8,scores={career=12} ] at @s run execute as @e[tag=team] if score @s team = @p team run tag @s remove chosen_12
...
scoreboard players set @p[distance=..20,tag=choose_8 ] all_ultcharge 0
title @p[distance=..20,tag=choose_8 ] times 0 10 5
title @p[distance=..20,tag=choose_8 ] subtitle ""
title @p[distance=..20,tag=choose_8 ] title ""
