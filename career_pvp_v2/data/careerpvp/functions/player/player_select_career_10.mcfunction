...
execute as @p[distance=..20,tag=choose_10 ] at @s unless score @s career matches 10 run execute as @e[tag=team] if score @s team = @p team if entity @s[tag=chosen_10] run tellraw @p "不可以选择与队友重复的职业"
execute as @p[distance=..20,tag=choose_10 ] at @s unless score @s career matches 10 run execute as @e[tag=team] if score @s team = @p team if entity @s[tag=chosen_10] run tag @p remove choose_10
execute as @p[distance=..20,tag=choose_10 ] at @s unless score @s career matches 1 unless score @s career matches 6..7 unless score @s career matches 10 run execute as @e[tag=team] if score @s team = @p team if score @s career_dps matches 2.. run tellraw @p "该类别职业已经达到上限。如需和队友更换，请先取消职业选择"
execute as @p[distance=..20,tag=choose_10 ] at @s unless score @s career matches 1 unless score @s career matches 6..7 unless score @s career matches 10 run execute as @e[tag=team] if score @s team = @p team if score @s career_dps matches 2.. run tag @p remove choose_10
...
scoreboard players set @p[distance=..20,tag=choose_10 ] all_ultcharge 0
