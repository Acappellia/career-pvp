...
execute as @p[distance=..20,tag=choose_9 ] at @s unless score @s career matches 9 run execute as @e[tag=team] if score @s team = @p team if entity @s[tag=chosen_9] run tellraw @p "不可以选择与队友重复的职业"
execute as @p[distance=..20,tag=choose_9 ] at @s unless score @s career matches 9 run execute as @e[tag=team] if score @s team = @p team if entity @s[tag=chosen_9] run tag @p remove choose_9
execute as @p[distance=..20,tag=choose_9 ] at @s unless score @s career matches 2 unless score @s career matches 5 unless score @s career matches 8..9 run execute as @e[tag=team] if score @s team = @p team if score @s career_support matches 2.. run tellraw @p "该类别职业已经达到上限。如需和队友更换，请先取消职业选择"
execute as @p[distance=..20,tag=choose_9 ] at @s unless score @s career matches 2 unless score @s career matches 5 unless score @s career matches 8..9 run execute as @e[tag=team] if score @s team = @p team if score @s career_support matches 2.. run tag @p remove choose_9
...
scoreboard players set @p[distance=..20,tag=choose_9 ] all_ultcharge 0
title @p[distance=..20,tag=choose_9 ] times 0 10 5
title @p[distance=..20,tag=choose_9 ] subtitle ""
title @p[distance=..20,tag=choose_9 ] title ""
